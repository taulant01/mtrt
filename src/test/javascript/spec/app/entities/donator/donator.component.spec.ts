...
import { DonatorComponent } from 'app/entities/donator/donator.component';
import { DonatorService } from 'app/entities/donator/donator.service';
import { Donator } from 'app/shared/model/donator.model';

describe('Component Tests', () => {
  describe('Donator Management Component', () => {
    let comp: DonatorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DonatorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.donators && comp.donators[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
