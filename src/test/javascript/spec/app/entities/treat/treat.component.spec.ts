...
import { TreatComponent } from 'app/entities/treat/treat.component';
import { TreatService } from 'app/entities/treat/treat.service';
import { Treat } from 'app/shared/model/treat.model';

describe('Component Tests', () => {
  describe('Treat Management Component', () => {
    let comp: TreatComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TreatComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.treats && comp.treats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
